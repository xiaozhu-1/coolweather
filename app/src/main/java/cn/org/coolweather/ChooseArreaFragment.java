...
import cn.org.coolweather.db.City;
import cn.org.coolweather.db.County;
import cn.org.coolweather.db.Province;
...
public class ChooseArreaFragment extends Fragment {
    ...
    private void queryCities(){
        ...
        if (cityList.size()>0){
            ...
            String address = URL_IP+"/"+provinceCode;
            //查询当前省份的市
    ...
    /**
     * 查询选中市内的所有县，优先数据库查询，如果没有查询到再去服务器上查询
     */
    private void queryCounties(){
        ...
        if (countyList.size()>0){
            ...
            String address = URL_IP+"/"+provinceCode+"/"+cityCode;
